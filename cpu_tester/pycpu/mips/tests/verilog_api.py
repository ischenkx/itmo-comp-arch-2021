...
class VerilogApi(object):
    ...
    def _compile_tests(self):
        subprocess.check_output(
            f'iverilog -o {self._get_build_file_path()} {self._iverilog_build_flags} -DSOURCE_FILE="\\"{self._instructions_folder_path}/{self._instructions_file_name}\\"" {self.test_path}'
        )
